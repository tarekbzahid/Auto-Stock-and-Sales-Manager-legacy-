...
Begin VB.Form frmbike_sales 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frmbike_sales.frx":F172
         Left            =   9720
         List            =   "frmbike_sales.frx":F17C
      ...
      Begin MSDataListLib.DataList DataList1 
         Bindings        =   "frmbike_sales.frx":F18E
         Height          =   2400
         Left            =   120
         TabIndex        =   50
         TabStop         =   0   'False
   ...
   Begin MSDataListLib.DataCombo dtprm 
      Bindings        =   "frmbike_sales.frx":F1A5
      Height          =   315
      Left            =   12360
      TabIndex        =   33
      TabStop         =   0   'False
   ...
   Begin VB.Image Image2 
      Height          =   615
      Left            =   0
      Picture         =   "frmbike_sales.frx":F1BE
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7545
   End
...
If cmdsearch.Caption = "Clear Search" Then
   ...
   adostock.RecordSource = "SELECT *FROM stock_assembled "
   adostock.Refresh
