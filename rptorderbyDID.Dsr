VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptorderbyDID 
   Bindings        =   "rptorderbyDID.dsx":0000
   Caption         =   "Order by DID"
   ClientHeight    =   10950
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   20250
   Icon            =   "rptorderbyDID.dsx":0017
   MDIChild        =   -1  'True
   _ExtentX        =   35719
   _ExtentY        =   19315
   _Version        =   393216
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E5-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         Object.Width           =   1725
         Object.Height          =   1860
         Picture         =   "rptorderbyDID.dsx":F189
      EndProperty
      ItemType2       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptorderbyDID"
