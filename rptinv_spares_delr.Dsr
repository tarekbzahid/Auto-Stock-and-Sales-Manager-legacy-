VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptinv_spares_delr 
   Bindings        =   "rptinv_spares_delr.dsx":0000
   Caption         =   "Spares Invoice"
   ClientHeight    =   7980
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   10140
   Icon            =   "rptinv_spares_delr.dsx":0017
   MDIChild        =   -1  'True
   ...
   EndProperty
End
Attribute VB_Name = "rptinv_spares_delr"
