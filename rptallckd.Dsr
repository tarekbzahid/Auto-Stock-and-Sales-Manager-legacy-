VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptallckd 
   Bindings        =   "rptallckd.dsx":0000
   Caption         =   "CKD LIST"
   ClientHeight    =   10950
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   20250
   Icon            =   "rptallckd.dsx":0017
   MDIChild        =   -1  'True
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item5 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "ALL CKD SUMMARY"
      EndProperty
      ItemType6       =   7
